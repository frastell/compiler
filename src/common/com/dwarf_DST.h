...
*/
#define DST_no_flag                0x00000000LL /* No flag values are set */
#define DST_flag_external          0x00000001LL /* AT_external = TRUE */
#define DST_flag_declaration       0x00000002LL /* AT_declaration = TRUE */
#define DST_flag_prototyped        0x00000008LL /* AT_prototyped = TRUE */
#define DST_flag_memdef            0x00000010LL /* Has an AT_specification */
#define DST_flag_const             0x00000020LL /* Has an AT_const_value */
#define DST_flag_automatic         0x00000040LL /* Is a local variable */
#define DST_flag_optional_parm     0x00000080LL /* AT_is_optional = TRUE */
#define DST_flag_variable_parm     0x00000100LL /* AT_variable_parameter=TRUE */
#define DST_flag_bitfield          0x00000200LL /* TRUE when a bitfield member */
#define DST_flag_comm		   0x00000400LL /* TRUE if variable is part of a common block */
#define DST_flag_lb_cval	   0x00000800LL /* true if lower bound of subrange is constant */
#define DST_flag_ub_cval	   0x00001000LL /* true if upper bound of subrange is constant */
#define DST_flag_cval	   	   0x00002000LL /* true if it is a constant */
#define DST_flag_artificial	   0x00004000LL /* true if it is an artificial entity */
#define DST_flag_deref		   0x00008000LL /* true if symbol should be dereferenced */
#define DST_flag_base_deref	   0x00010000LL /* true if symbol's base should be dereferenced */
#define DST_flag_count   	   0x00020000LL /* true if subrange contains extent(ie: !upper bound) */
#define DST_flag_stride_1byte  	   0x00040000LL /* true if DW_AT_stride is in byte increments   */
#define DST_flag_stride_2byte  	   0x00080000LL /* true if DW_AT_stride is in 2 byte increments */ 
#define DST_flag_f90_pointer       0x00100000LL /* true if symbol is a pointer */
#define DST_flag_allocatable       0x00200000LL /* true if symbol is allocatable*/
#define DST_flag_assumed_shape     0x00400000LL /* true if symbol is assumed shape*/
#define DST_flag_assumed_size      0x00800000LL /* true if symbol is assumed size*/
#define DST_flag_assoc_fe          0x10000000LL /* pointer to front-end entity */
#define DST_flag_assoc_be          0x20000000LL /* pointer to back-end entity */
#define DST_flag_assoc_idx         0x40000000LL /* index to back-end entity */

#define DST_flag_info_mark         0x80000000LL /* DST_info mark for traversal */
#define DST_flag_static		   0x100000000LL /* Has no AT_data_member_location */
#ifdef KEY
#define DST_flag_should_emit       0x200000000LL /* should emit this DST info */
#endif
#ifdef TARG_X8664
#define DST_flag_GNU_vector        0x400000000LL /* GNU vector extension */
#endif

#ifdef KEY
#define DST_flag_mask              0xffffffffffffffffLL
#else
...
#ifdef KEY
#define DST_SET_should_emit(flag) (flag |= DST_flag_should_emit)
#endif
#ifdef TARG_X8664
...
#ifdef KEY
#define DST_RESET_should_emit(flag) (flag &= ~DST_flag_should_emit)
#endif
#ifdef TARG_X8664
...
#ifdef KEY
#define DST_IS_should_emit(flag) (flag & DST_flag_should_emit)
#endif
#ifdef TARG_X8664
