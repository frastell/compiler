...
#ifdef KEY
// Returns the log (base 2) of align. If align is not a power of 2, returns
// the log (base 2) of the next higher power of 2. TY_log_base2() is more
// efficient when align is known to be a power of 2.
extern UINT
