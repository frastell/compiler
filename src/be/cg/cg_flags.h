 ...
 *      to be if converted.
 *
 *  BOOL CG_enable_load_index
 *      allow conversions of memory OPs into indexed memory OPs
 *
 *  INT32 CG_maxinss
...
#ifdef KEY
 *  CGEXP_reuse_tn
 *	Try to eliminate extra copy OPs when expanding SELECT.
 *
...
#ifdef KEY
extern BOOL CG_split_bb;
extern BOOL CG_split_bb_Set;
#endif
...
extern BOOL LRA_inflate_gtn_request;
...
extern BOOL CG_LOOP_nested_interleave;
extern BOOL CG_LOOP_nested_interleave_specified;
...
extern INT32 CG_muld;
extern INT32 CG_hw_round;
extern INT32 CG_hw_stall;
extern BOOL CG_muld_overridden;
extern BOOL CG_hw_round_overridden;
extern BOOL CG_hw_stall_overridden;
#endif
...
extern BOOL LOCS_Retry;
extern BOOL LOCS_Retry_set;
extern BOOL LOCS_Reduce_Prefetch;
extern BOOL LOCS_Reduce_Prefetch_set;
extern BOOL LOCS_Add_Copy;
extern BOOL LOCS_Add_Copy_set;
extern BOOL LOCS_Renumber_Cycles;
extern BOOL LOCS_Renumber_Cycles_set;
#endif
#ifdef TARG_X8664
...
#endif
#ifdef KEY
extern UINT32 CG_LOOP_post_remainder_loop;
extern BOOL CG_LOOP_convert_prefetch_to_load;
#endif
