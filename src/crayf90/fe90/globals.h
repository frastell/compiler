...
struct  expr_semantics_args    {basic_type_type		type		: 8;
...
#ifdef KEY /* Bug 934, Sicortex 7156 */
				...
				/* Set for an array section whose underlying
				 * array is allocatable though the section is
				 * of course not allocatable. Allocatable
				 * base && contig_array implies contiguous
				 * elements, no need to check flag in dope */
				boolean			allocatable_base: 1;
				Uint			UNUSED2		: 4;
#else /* KEY Bug 934 */
				Uint			UNUSED2		: 6;
#endif /* KEY Bug 934 */
...
#ifdef KEY /* Bug 7969 */
				 /* Suppress run-time bounds checks inside
				  * data statement */
				 int	        in_data_stmt;
#endif /* KEY Bug 7969 */
				 int		blockable_count;
...
#ifdef KEY /* Bug 5091 */
extern  void  move_alloc_intrinsic  (opnd_type *, expr_arg_type *, int *);
#endif /* KEY Bug 5091 */
...
#ifdef KEY /* Bug 7969 */
extern  void		copy_subtree(opnd_type *, opnd_type *, int, int);
#else /* Bug 7969 */
...
#ifdef KEY /* Bug 8502 */
extern	int		gen_if_stmt(opnd_type *, int, int, int, int, int, int);
extern void		short_circuit_high_level_if(void);
#else /* KEY Bug 8502 */
...
#ifdef KEY /* Bug 7969 */
extern	boolean		needs_bounds_check(int, boolean);
#else /* KEY Bug 7969 */
